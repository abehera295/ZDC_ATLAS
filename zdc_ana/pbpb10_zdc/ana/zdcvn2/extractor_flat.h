...
class extractor_flat {
  ...
  */
  ...
  TProfile *hResCent_Z1F1_fg[NHAR],*hResCent_Z1F2_fg[NHAR],*hResCent_Z1Z2_fg[NHAR];
  TProfile *hResCent_Z2F1_fg[NHAR],*hResCent_Z2F2_fg[NHAR],*hResCent_Z2Z1_fg[NHAR];
  TProfile *hResCent_F1Z1_fg[NHAR],*hResCent_F1Z2_fg[NHAR],*hResCent_F1F2_fg[NHAR];
  TProfile *hResCent_F2Z1_fg[NHAR],*hResCent_F2Z2_fg[NHAR],*hResCent_F2F1_fg[NHAR];
  
  TProfile *hResCent_Z1F1_bg[NHAR],*hResCent_Z1F2_bg[NHAR],*hResCent_Z1Z2_bg[NHAR];
  TProfile *hResCent_Z2F1_bg[NHAR],*hResCent_Z2F2_bg[NHAR],*hResCent_Z2Z1_bg[NHAR];
  TProfile *hResCent_F1Z1_bg[NHAR],*hResCent_F1Z2_bg[NHAR],*hResCent_F1F2_bg[NHAR];
  TProfile *hResCent_F2Z1_bg[NHAR],*hResCent_F2Z2_bg[NHAR],*hResCent_F2F1_bg[NHAR];

  TProfile *hCorrCent_EF_fg[NHAR][4],*hCorrCent_EZ_fg[NHAR][4],*hCorrCent_FZ_fg[NHAR][4];
  TProfile *hCorrCent_EE_fg[NHAR],*hCorrCent_FF_fg[NHAR],*hCorrCent_ZZ_fg[NHAR];
  TProfile *hCorrCent_EF_bg[NHAR][4],*hCorrCent_EZ_bg[NHAR][4],*hCorrCent_FZ_bg[NHAR][4];
  TProfile *hCorrCent_EE_bg[NHAR],*hCorrCent_FF_bg[NHAR],*hCorrCent_ZZ_bg[NHAR];
