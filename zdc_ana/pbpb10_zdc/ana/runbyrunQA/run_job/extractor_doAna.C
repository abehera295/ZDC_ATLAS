...
void extractor_flat::Run_doAna() {
  ...
  for (int ihar=0; ihar<NHAR; ihar++) {
    for (int icent=0; icent<NCENT; icent++) {
      ...
      std::vector<double> res_vec_FCal_flat = discFourrier(hDphi_FCal_fg[icent][ihar],0);
      hResCent_flat_FCal[ihar]->SetBinContent(icent+1, res_vec_FCal_flat.at(0) );
      hResCent_flat_FCal[ihar]->SetBinError  (icent+1, res_vec_FCal_flat.at(1) );

      std::vector<double> res_vec_FCal_mix = discFourrier(hDphi_FCal_rat[icent][ihar],0);
      hResCent_mix_FCal[ihar]->SetBinContent(icent+1, res_vec_FCal_mix.at(0) );
      hResCent_mix_FCal[ihar]->SetBinError  (icent+1, res_vec_FCal_mix.at(1) );
	...
	hResCent_recn[ihar]->SetBinError  (icent+1, hRes_recn[icent][ihar]->GetMeanError());
      */
      ...
      std::vector<double> res_vec_Zdc_flat = discFourrier(hDphi_Zdc_fg[icent][ihar],0);
      hResCent_flat_Zdc[ihar]->SetBinContent(icent+1, res_vec_Zdc_flat.at(0) );
      hResCent_flat_Zdc[ihar]->SetBinError  (icent+1, res_vec_Zdc_flat.at(1) );

      std::vector<double> res_vec_Zdc_mix = discFourrier(hDphi_Zdc_rat[icent][ihar],0);
      hResCent_mix_Zdc[ihar]->SetBinContent(icent+1, res_vec_Zdc_mix.at(0) );
      hResCent_mix_Zdc[ihar]->SetBinError  (icent+1, res_vec_Zdc_mix.at(1) );
    }
    ...
    std::vector<double> res_vec_Zdc_mix = discFourrier(hDphi_Zdc_allCent_rat[0],ihar);
    hRes_mix_Zdc_allCent->SetBinContent(ihar+1, res_vec_Zdc_mix.at(0) );
    hRes_mix_Zdc_allCent->SetBinError  (ihar+1, res_vec_Zdc_mix.at(1) );
  }
	...
	*/
	...
	for (int ieta=0; ieta<NETA+4; ieta++) {
	  for (int ipt=0; ipt<NPT; ipt++) {
	    ...
	    hVn_Zdc_pt_res_fg[icent][iside][ihar][ieta]->SetBinError  (ipt+1, vnF/reso_2sub*sqrt( pow(vnF_e/vnF,2) + pow(reso_2sub_e/reso_2sub,2)));
	    ...
	    hVn_Zdc_pt_res_bg[icent][iside][ihar][ieta]->SetBinError  (ipt+1, vnB/reso_2sub*sqrt( pow(vnB_e/vnB,2) + pow(reso_2sub_e/reso_2sub,2)));
	    /*
	...
	for (int ipt=0; ipt<NPT+1; ipt++) {
	  for (int ieta=0; ieta<NETA; ieta++) {
	    ...
	    hVn_Zdc_eta_res_fg[icent][iside][ihar][ipt]->SetBinError  (ieta+1, vnF/reso_2sub*sqrt( pow(vnF_e/vnF,2) + pow(reso_2sub_e/reso_2sub,2)));
	    ...
	    hVn_Zdc_eta_res_bg[icent][iside][ihar][ipt]->SetBinError  (ieta+1, vnB/reso_2sub*sqrt( pow(vnB_e/vnB,2) + pow(reso_2sub_e/reso_2sub,2)));
	    /*
	    double vnSF=hVnS_Zdc_fg[icent][iside][ihar]->GetBinContent(ipt+1,ieta+1);
            double vnSF_e=hVnS_Zdc_fg[icent][iside][ihar]->GetBinError(ipt+1,ieta+1);
            double vnSB=hVnS_Zdc_bg[icent][iside][ihar]->GetBinContent(ipt+1,ieta+1);
	...
	for (int ieta=0; ieta<NETA+4; ieta++) {
	  for (int ipt=0; ipt<NPT+1; ipt++) {
	    ...
	    hVn_Zdc_cent_res_fg[iside][ihar][ipt][ieta]->SetBinError  (icent+1, vnF/reso_2sub*sqrt( pow(vnF_e/vnF,2) + pow(reso_2sub_e/reso_2sub,2)));
	    ...
	    hVn_Zdc_cent_res_bg[iside][ihar][ipt][ieta]->SetBinError  (icent+1, vnB/reso_2sub*sqrt( pow(vnB_e/vnB,2) + pow(reso_2sub_e/reso_2sub,2)));
	    /*
	    double vnSF=hVnS_Zdc_fg[icent][iside][ihar]->GetBinContent(ipt+1,ieta+1);
            double vnSF_e=hVnS_Zdc_fg[icent][iside][ihar]->GetBinError(ipt+1,ieta+1);
            double vnSB=hVnS_Zdc_bg[icent][iside][ihar]->GetBinContent(ipt+1,ieta+1);
