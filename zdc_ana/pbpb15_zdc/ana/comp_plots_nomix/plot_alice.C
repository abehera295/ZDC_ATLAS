...
void plot_alice(){
...
#ifdef withBG
  TFile *fin=new TFile("../zdcvn/Output_doAna_vn_mix2.root","read");
#endif
#ifndef withBG
  ...
  //gVnOdd_eta_res[icent1][ihar][ipt]->GetXaxis()->SetRangeUser(-0.8,0.8);
  gVnOdd_eta_res[icent1][ihar][ipt]->GetYaxis()->SetRangeUser(-0.002,0.002);
  ...
  gVnOdd_eta_res[icent2][ihar][ipt]->GetYaxis()->SetRangeUser(-0.002,0.002);
  ...
  */
  ...
  TFile *fout=new TFile("./v1plots_2015.root","recreate");
  fout->cd();
